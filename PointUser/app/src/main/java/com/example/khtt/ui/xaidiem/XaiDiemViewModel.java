...
public class XaiDiemViewModel extends AndroidViewModel {
    ...
    public XaiDiemViewModel(@NonNull Application application) {
        super(application);
    ...
    public void upDateKhachHang(String phoneNumber, int points, String note) {
        executor.execute(()-> {
            ...
            if (kh != null) {
                kh.setPoints(kh.getPoints() - points);
                kh.setNote(note);
